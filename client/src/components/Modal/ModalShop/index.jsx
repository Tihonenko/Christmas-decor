...
import {
	getAllShopTypes,
	setFocus
} from "redux/features/shopType/shopTypeSlice";
...
const ModalShop = ({ active, setActive, createItem }) => {
	...
	return (
		active && (
			<div className="overflow-hidden" onClick={() => setActive(false)}>
				<div onClick={e => e.stopPropagation()}>
					<form
						onSubmit={e => e.preventDefault()}
						className="flex flex-col gap-3"
					>
						<h3 className="mb-3 text-base font-semibold">Create Shop post</h3>
						...
						<label
							className=" w-full cursor-pointer  bg-lightwhite py-2 px-[26px]  text-center text-lightblack 
	hover:bg-lightblack hover:text-lightwhite"
						>
							Image
							<MyInput
